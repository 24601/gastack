...
**YOU ARE IN: `gastack/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/gastack/` (rig root) or other directories
...
**Your mail address:** `gastack/polecats/furiosa`
**Your rig:** gastack
**Your Witness:** `gastack/witness`
...
| Ask Witness for help | `gt mail send gastack/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`gastack/witness`) when:
...
```bash
gt mail send gastack/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
